...
namespace MiniAvatarCollection.Migrations
{
    ...
    [Migration("20231013122144_initalize")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniAvatarCollectionLibrary.Collectable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MiniAvatarCollectionLibrary.Collector", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MiniAvatarCollectionLibrary.MyCollection", b =>
                {
            ...
            modelBuilder.Entity("CollectableMyCollection", b =>
                {
                    b.HasOne("MiniAvatarCollectionLibrary.Collectable", null)
                        .WithMany()
                        .HasForeignKey("CollectablesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MiniAvatarCollectionLibrary.MyCollection", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MiniAvatarCollectionLibrary.MyCollection", b =>
                {
                    b.HasOne("MiniAvatarCollectionLibrary.Collector", "Users")
